...
public class App extends javax.swing.JFrame {
    ...
    private LinuxModule linux = new LinuxModule();
    ...
    private void initComponents() {
        ...
        setTitle("MAC CHANGE by Santiihoyos");
        setResizable(false);

        jLabel1.setFont(new java.awt.Font("Dialog", 1, 18)); // NOI18N
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("Ubuntu MAC changer v1.2");

        jLabel2.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        jLabel2.setText("INTERFACE:");

        jLabel3.setText("New MAC: ");

        jTextField2.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jTextField2.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        jTextField2.setText("22:22:22:22:22:22");

        jLabel4.setFont(new java.awt.Font("Dialog", 1, 10)); // NOI18N
        jLabel4.setText("ALERT: when you press the button \"change\",");

        jLabel5.setFont(new java.awt.Font("Dialog", 1, 10)); // NOI18N
        jLabel5.setText("the system will ask password for security.");
        ...
        jRadioButton2.setText("try Autodetect");
        ...
        jLabel6.setText("(wlan0, eth0... etc...)");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            if (jRadioButton1.isSelected()) {
                ...
                temp = linux.scriptCreator(jTextField2.getText(), jTextField1.getText());
                ...
                temp = linux.scriptCreator(jTextField2.getText(), jComboBox1.getItemAt(jComboBox1.getSelectedIndex()).toString());
                bandera = true;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        jTextField2.setText(comun.macRandom());
